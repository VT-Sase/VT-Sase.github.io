...
const JOIN_URL = "https://linktr.ee/saseatvt";
        ...
        <div className={styles.infoGrid}>
          <section className={`${styles.infoCard} ${styles.missionCard}`}>
            ...
            <p>
              ...
              engineers and scientists who lead with confidence and give back
              to their communities.
            </p>

            <div className={styles.cardPhoto}>
              <Image
                src="/images/DSC_0211.JPG"
          ...
          <section className={`${styles.infoCard} ${styles.aboutCard}`}>
            ...
            <p>
              ...
              scientists and engineers of Asian heritage for success in the
              global business world. We connect students with mentorship,
              professional development, and a close-knit community at Virginia
              Tech.
            </p>
